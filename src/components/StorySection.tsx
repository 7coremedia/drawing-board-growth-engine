      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="flex justify-center mb-16">
          <div className="relative">
            <div className="bg-gradient-to-br from-green-800 to-green-900 p-8 rounded-lg glow w-80 h-56 border border-green-700">
              {/* Notification circle */}
              ...
              <div className="text-white h-full flex flex-col justify-between">
                ...
                <Button 
                  ...
                  className="bg-accent text-primary hover:bg-accent/90 font-black text-sm px-6 py-3 w-full"
                >
                  Read Letter
                </Button>
              </div>
        ...
        {isLetterOpen && (
          <div className="animate-roll-down overflow-hidden">
            <div className="max-w-4xl mx-auto py-16">
              <div className="space-y-8 text-lg lg:text-xl leading-relaxed" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                <div className="mb-8">
                ...
                {textLines.map((line, index) => {
                  ...
                  if (line === "Customers.") {
                    return (
                      <p key={index} 
                         className={`font-black text-primary text-3xl lg:text-4xl transition-all duration-1000 transform ${
                  ...
                  if (line.includes("Rule #1")) {
                    return (
                      <div key={index} 
                           className={`bg-primary/10 p-8 rounded-xl glow transition-all duration-1000 transform ${
                             shouldShow ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
                           }`}>
                ...
                <div className={`text-center pt-12 transition-all duration-1000 transform ${
                  ...
                  <Button 
                    size="lg"
                    className="bg-primary hover:bg-primary/90 text-white font-black px-12 py-4 text-lg glow"
                  >
                    Get My Solution Now
                  </Button>
                </div>
